...
class Board {
    ...
    final Piece get(Square s) {
        int newcol = s.col();
        int newrow = s.row();
        return get(newcol, newrow);  // FIXME
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                newboard = newboard + " " + board[i][j].toString();
//                System.out.println("String : " + newboard);
            }
            newboard += "\n";
        }
        return newboard;
